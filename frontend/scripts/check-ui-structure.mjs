...
assert(dashboardPage.includes("dashboard-app-actions"), "对话页左侧栏需要提供应用核心入口，避免把引导堆在聊天输入区下方");
assert(dashboardPage.indexOf('class="dashboard-app-actions"') > dashboardPage.indexOf('<aside class="sidebar">') && dashboardPage.indexOf('class="dashboard-app-actions"') < dashboardPage.indexOf("<RuntimeMetrics"), "对话页应用入口需要位于左侧栏会话导航和运行状态之间");
assert(dashboardPage.includes("dashboardQuickActions") && dashboardPage.includes('label: "添加微信"') && dashboardPage.includes('label: "人格设定"') && dashboardPage.includes('label: "对话数据"') && dashboardPage.includes('label: "未来任务"') && dashboardPage.includes('label: "数据统计"') && dashboardPage.includes('label: "平台日志"'), "对话页应用入口需要覆盖添加微信、人格设定、对话数据、未来任务、数据统计和平台日志");
assert(dashboardPage.includes('to: "/integrations"') && dashboardPage.includes('to: "/settings"') && dashboardPage.includes('to: "/memory"') && dashboardPage.includes('to: "/diagnostics"') && dashboardPage.includes('to: "/services"'), "对话页应用入口需要接到现有后端页面路由，不能做成无效按钮");
assert(dashboardCss.includes(".dashboard-app-actions") && dashboardCss.includes(".dashboard-app-action-grid") && dashboardCss.includes(".dashboard-app-action"), "对话页应用入口需要有左侧栏专用样式，保证紧凑、整齐、可读");
