...
assert(integrationsPage.includes("IntegrationLoginPanel") && integrationLoginPanel.includes("integration-login-panel") && integrationsPage.includes("integration-sessions-panel"), "接入页右栏需要上方登录控制、下方微信聊天列表");
